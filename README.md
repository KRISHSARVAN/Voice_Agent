...
A real-time voice-enabled RAG (Retrieval-Augmented Generation) for [Suvit](https://suvit.io) customer support. Users can speak questions about Suvit's accounting automation platform and receive answers - spoken aloud in Indian languages - backed by content scraped from [help.suvit.io](https://help.suvit.io).
